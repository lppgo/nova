...
var _nameToDefaultTemplate = map[string]string{
	...
	"kraken-push-cli":    ProxyTemplate,

	// 冗余.
	"base.conf":               BaseTemplate,
	"kraken-agent.conf":       AgentTemplate,
	"kraken-origin.conf":      OriginTemplate,
	"kraken-build-index.conf": BuildIndexTemplate,
	"kraken-tracker.conf":     TrackerTemplate,
	"kraken-push-cli.conf":    ProxyTemplate,
}
